...
const PrivacyPolicy = ({ className }: { className?: string }) => {
  // https://www.termsfeed.com/live/9e5336f0-ee6a-47c0-b699-0536d34a2d76
      ...
      <MaxWidthWrapper className="prose">
        <>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to kashyapsuhas.com, accessible from{' '}
                <a
                  href="https://www.kashyapsuhas.com/"
          ...
          <ul>
            <li>
              ...
              <a
                href="https://www.kashyapsuhas.com/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.kashyapsuhas.com/contact
              </a>
            </li>
          </ul>
        </>
