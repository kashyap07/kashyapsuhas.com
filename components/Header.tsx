...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 h-16 w-full border-b bg-background bg-opacity-80 backdrop-blur backdrop-saturate-200 backdrop-filter transition-all duration-500 ease-out
