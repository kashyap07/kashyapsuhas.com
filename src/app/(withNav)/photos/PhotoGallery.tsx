...
function ImageModal() {
  ...
  return (
    ...
    >
      <div
        className="fixed left-0 top-0 z-50 flex h-full w-full cursor-pointer flex-col items-center justify-center gap-4 bg-black/50 px-4 py-24 backdrop-blur-xl md:gap-8"
        onClick={closeImage}
      >
        <ImageAutoHeight
