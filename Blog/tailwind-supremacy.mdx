...
Ok, the one con is that you have TOO much control. You get to build your components on your own and come up with the design system. The obvious issue here is the amount of time things are going to take for this.

There are solutions to this obviously - Daisy UI and such.  
(No, it's no a 360 back to bootstrap. The difference here is the amount of control you still have over things).

That's it, please give Tailwind a shot!