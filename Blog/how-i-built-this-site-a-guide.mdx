...
I've been wanting to build a site to share my experiences in life - be it tech, food, travel - for quite a while. I'm not quite sure what exactly made me start building one, but I did exactly that. Paid for a domain and started going at it right away. I figured documenting how I did this could probably be helpful to someone or myself in the future. Massive shout-outs to [https://twitter.com/joshwcomeau](Josh Comeau)'s beautiful website - [https://www.joshwcomeau.com/](https://www.joshwcomeau.com/) who had detailed explanation of how he built his blog and my friend [https://twitter.com/shreyash14s](https://twitter.com/shreyash14s) who helped me a ton along the way.

## Go Daddy!

Step 1 of doing anything web - buying a domain for it. You build it or not, you gotto buy one. This is was something new to me, and I wasn't aware of all the intricasies of linking your hosting site to a domain. So went along with GoDaddy - might not be the best bang for the buck, but there are tons of videos/articles on the internet detailing the steps to link it with yout hosting provider.  
...
`Heroku` as the hosting provider. I did not know about Vercel/Netlify at the point I set this up. They could be better, I will explore about them in the future. For now, Heroku did everything I wanted: 1 click to link up to my project git repo (see: [https://github.com/kashyap07/kashyapsuhas.com](github repo)), (almost) 0-configure auto-deploy whenever I commit to the `main` branch with good build logs,and a reasonably low cost as well. I'm currently paying for the Hobby tier which costs me 7 USD per month.  
