...
<del>[Heroku](https://www.heroku.com/) as the hosting provider. I did not know about Vercel/Netlify at the point I set this up. They could be better, I will explore them in the future.</del>

<del>For now, Heroku does everything I want - 1 click to link up to my project git repo see: [github repo](https://github.com/kashyap07/kashyapsuhas.com), (almost) 0-configure auto-deploy whenever I commit to `main` branch with good build logs, and a reasonably low cost as well. I'm currently paying for the _Hobby tier_ which costs me $7 per month.</del>
