...
<ImageMDX alt={`TTArtisan Lens set up on my Sony A7C2`} src={"/blog/shiny-lens.jpg"} />
...
The point is: stop obsessing over technical details and go have fun with street photography letting the camera fade into the background.
