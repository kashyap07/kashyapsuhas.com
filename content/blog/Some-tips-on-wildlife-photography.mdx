...
Will keep this updated as and when I learn new things.

1. When zoomed in, it’s quite difficult to use the screen. Use the evf to track a moving subject - it’s way better!
2. You’d typically want to punch-in into a photo that’s been shot. For which, you do not want to set high ISO - without which the photo will be far too grainy for any kind of use. Use low ISO.
3. You’ll automatically have to shoot at lower shutter speeds - the issue is that photo is going to be blurry. 2 ways to counteract this.
