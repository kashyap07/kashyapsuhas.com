...
<ImageMDX
  mdHalfWidth
  alt={`Mosranna with Pom in a white bowl`}
  src={"/blog/mosranna1.jpg"}
/>
...
<ImageMDX mdHalfWidth alt={`Mosranna with grapes`} src={"/blog/mosranna2.jpg"} />
