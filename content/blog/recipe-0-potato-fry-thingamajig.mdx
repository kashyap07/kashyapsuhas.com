...
<ImageMDX alt={`yam fry`} src={"/blog/yam-fry.jpg"} />
It doesn't really have to be Potatoes at all. Here's something I cooked tonight
with ಸುವರ್ಣ ಗಡ್ಡೆ (Elephant Foot Yam). This doesn't even follow the recipe I've
mentioned below, that's the beauty of it. Take a vegetable, throw it with oil
and spices, then throw whatever you want at it, and enjoy!
...
<ImageMDX alt={`potato fry`} src={"/blog/potato-fry.jpg"} />
